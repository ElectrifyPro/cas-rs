...
impl Vm {
    ...
    pub fn run(&self) -> Value {
        ...
        while instruction_pointer.1 < self.chunks[self.chunk].instructions.len() {
            let instruction = &self.chunks[self.chunk].instructions[instruction_pointer.1];
            match instruction {
