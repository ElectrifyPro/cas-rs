...
pub fn draw() {
    ...
    graph.add(cas_parser::parser::Parser::new("erf(y)").try_parse_full::<cas_parser::parser::ast::expr::Expr>().unwrap());
    graph.add(cas_parser::parser::Parser::new("erf(x)").try_parse_full::<cas_parser::parser::ast::expr::Expr>().unwrap());
